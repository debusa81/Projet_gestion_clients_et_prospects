...
public class Prospects  extends Societe
{
     ...
     * @param prospect_date
     */
    public void setProspect_date(LocalDate prospect_date) throws Exception_entites {

        if (prospect_date==null){
            throw new Exception_entites("la date ne peut pas etre null");
        }
    ...
    public void setProspect_interesse(String prospect_interesse)throws Exception_entites
    {
        //on initialise la variable val_prospect
                if (prospect_interesse=="oui"||prospect_interesse=="non"){
                }else {
                   throw new Exception_entites("la valeur de Prospect interesse  doit etre oui ou non");
                }
