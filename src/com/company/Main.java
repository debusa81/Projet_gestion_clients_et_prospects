...
public class Main {
    ...
    remplir_liste_prospects();
        ...
        public static void remplir_liste_clients()
        {
            ...
            try {
                cl = new Clients("SARL_alex",
                        ...
                        "monemail@a.com", "0606060606", "commentaires", 150000, 150);
                Clients cla = new Clients("Sarl_test",
                        "2", "rue Test", "54000", "NANCY",
                        "monemail@a.com", "0606060606", "commentaires", 150001, 151);
                Clients clb = new Clients("Sarl_alex",
                        "3", "rue Test", "54000", "NANCY",
                        "monemail@a.com", "06060606060", "commentaires", 152000, 130);
        ...
        public static void remplir_liste_prospects()
        {
            ...
            // Prospects pr = new Prospects("monprospect_test","1","rue test","54000","Nancy","mon_email@a.com","commentaires",,1);
            //System.out.println(pr.toString());
            ma_liste_prospects = new ArrayList<>();
            try {
                DateTimeFormatter format = DateTimeFormatter.ofPattern("dd/MM/yyyy");

                Prospects pr = new Prospects("Mon_prospect", "1", "Rue ma rue", "54000",
                        "Nancy"
                        , "email@email.com", "0606060606", "commentaire", LocalDate.parse("19/02/2021", format), "oui");
                Prospects pra = new Prospects("Mon_deuxieme_prospect", "2", "Rue ma rue", "54000",
                        "Nancy"
                        , "email@email.com", "06060606", "commentaire", LocalDate.parse("20/02/2021", format), "oui");
                Prospects prb = new Prospects("Mon_troisieme", "4", "Rue ma rue", "54000",
                        "Nancy"
                        , "email@email.com", "060606060", "commentaire", LocalDate.parse("18/02/2021", format), "oui");
